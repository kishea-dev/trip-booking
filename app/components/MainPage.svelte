...
<select class="js-example-basic-single form-control select2-hidden-accessible" name="state" data-select2-id="select2-data-1-790j" tabindex="-1" aria-hidden="true">
<option value="Amritsar" data-select2-id="select2-data-3-trow">Amritsar</option>
...
</select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="select2-data-2-lto4" style="width: 1298px;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-state-rs-container" aria-controls="select2-state-rs-container"><span class="select2-selection__rendered" id="select2-state-rs-container" role="textbox" aria-readonly="true" title="Amritsar">Amritsar</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
</div>
<div class="form-group border-bottom pb-2">
<label for="exampleFormControlSelect1" class="mb-2"><span class="icofont-google-map text-danger"></span> To</label><br>
<select class="js-example-basic-single form-control select2-hidden-accessible" name="state" data-select2-id="select2-data-4-59ab" tabindex="-1" aria-hidden="true">
...
<option value="Bathinda">Bathinda</option>
<option value="Bhiwani">Bhiwani</option>
<option value="Chandigarh" selected="" data-select2-id="select2-data-6-h9s6">Chandigarh</option>
<option value="Delhi">Delhi</option>
<option value="Fatehabad">Fatehabad</option>
<option value="Gurgaon">Gurgaon</option>
<option value="Hissar">Hissar</option>
...
<option value="Mumbai">Mumbai</option>
<option value="Nanded">Nanded</option>
</select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="select2-data-5-om5q" style="width: 1298px;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-state-mb-container" aria-controls="select2-state-mb-container"><span class="select2-selection__rendered" id="select2-state-mb-container" role="textbox" aria-readonly="true" title="Chandigarh">Chandigarh</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
</div>
